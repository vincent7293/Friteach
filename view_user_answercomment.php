...
<!-- 導覽列 -->
    ...
    <div id="page-wrapper">
       ...
       <br><br><button type='button' onclick="history.back()" class='btn btn-lg btn-primary'>返回到教導歷史</button></a><br>
       </div></div>
...
<?php
        ...
        if(!$rows['Q_Star']==null)
        {
            echo '<div class="row"><div class="col-lg-12">給提問者的星星：</div></div>';
            echo '<div class="demo">';
        ...
        else
        {
            ...
            echo "該用戶對提問者的評論：</div><br><div class='col-lg-6'>";
            echo  $rows['Q_Comment'];
            echo "</div></div>";
        ...
        if(!$rows['A_Star']==null)
        {
            echo '<div class="row"><div class="col-lg-12">提問者給予該用戶的星星：</div></div>';
            echo '<div class="demo">';
        ...
        {
            echo "<div class='row'><div class='col-lg-3'>";
            echo "提問者對該用戶的評論：</div><br><div class='col-lg-6'>";
            echo  $rows['A_Comment'];
            echo "</div></div>";
