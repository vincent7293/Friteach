...
<body>
    ...
    <?php
        ...
        $sql="SELECT DATE_FORMAT(A_Time,'%m/%d')AS D_Time,a.*,q.Q_Title FROM ans_list as a JOIN q_list as q ON q.Q_ID=a.Q_ID AND a.U_ID=$view_U_ID";
        $fetch=$db->query($sql);
    ?>
     ...
     <?php
                        ...
                        echo "<form class='form-horizontal' method='POST' action='view_user_answercomment.php'>";
