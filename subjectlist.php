...
<!-- 導覽列 -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
            	<div class="row">
            		<div class="col-lg-12">
                		<h1 class="page-header">科目</h1>
            		</div>
                </div>
              <div class="row">
                    <?php foreach($subjectlist as $value){ ?>
                <div class="col-lg-4 col-sm-4 col-xs-4">
                	<button type="button" class="btn btn-lg btn-primary subject center-block" onclick="location.href='questionlist.php?subjectid=<?php echo $value['S_ID']; ?>'">
