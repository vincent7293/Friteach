    ...
    ?>
                               <div class="table-responsive">
                                    <table class="table table table-hover ">
                                        <form class="form-horizontal" method="POST" action="passwordupdatedsucess.php">
                                             <tr>
                                                <td>請輸入密碼</td>
                                                <td>
                                                <?php 
                                                 echo '<input type="password" name="U_Password" maxlength="15" 
                                                id="U_Password" class="form-control" required="required"';
                                                 ?>
                                                </td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td>
                                                <?php 
                                                 echo '<input type="password" name="U_Newpassword" maxlength="15" 
                                                id="U_Newpassword" class="form-control" required="required"';
                                                 ?>
                                                </td>
                                            </tr>
                                             <tr>
                                                ...
                                                <td>
                                                <?php 
                                                 echo '<input type="password" name="U_Newpasswordcheck" maxlength="15" 
                                                id="U_Newpasswordcheck" class="form-control" required="required"';
                                                 ?>
                                                </td>
                                            </tr>                                     
...
<?php }?>
                           ...
                           <input id="submit" name="submit" type="submit"  class="btn btn-md btn-primary"  value="更換密碼">
