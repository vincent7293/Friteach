...
<!-- 導覽列 -->
    ...
    <div id="page-wrapper">
       ...
       <br><br><a href='questionhistory.php'><button type='button' class='btn btn-lg btn-primary'>返回到提問記錄</button></a><br>
       </div></div>
...
<?php
        ...
        {
            echo '<form role="form"  method="POST" action="q-commentsucess.php">';
            echo '<input type="hidden" name="starvalue" id="starvalue">';
            echo '<input type="hidden" name="A_ID" id="A_ID" value='.$rows['A_ID'].'>';
